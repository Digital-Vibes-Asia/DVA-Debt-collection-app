(function () {
  ...
  const CLIENT_ORGS = [
    ...
    { id: 'coway', code: 'CW', name: 'Coway', sub: 'Home equipment rentals · MY', bg: 'linear-gradient(135deg,#CFFAFE,#67E8F9)', fg: '#155E75',
      products: ['Water Purifier Rental','Air Purifier Rental','Mattress Rental','Water Softener','Multi-product Bundle'],
      balanceRange: [50, 3000], origRange: [100, 6000] },
    { id: 'maxis', code: 'MX', name: 'Maxis', sub: 'Postpaid & device plans · MY', bg: 'linear-gradient(135deg,#FEF9C3,#FDE68A)', fg: '#713F12',
      products: ['Postpaid Plan','Device Instalment','Maxis Broadband','Business Line'],
      balanceRange: [50, 5000], origRange: [100, 6000] },
    { id: 'umobile', code: 'UM', name: 'U Mobile', sub: 'Postpaid & prepaid · MY', bg: 'linear-gradient(135deg,#F3E8FF,#D8B4FE)', fg: '#6B21A8',
      products: ['Postpaid Plan','Device Instalment','U Mobile Home Fibre'],
